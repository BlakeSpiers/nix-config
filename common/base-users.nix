...
let
  ...
  # self.users such as:
  #
  # let cool-users = with self.users [ blake ]; in ...
  #
  # Alternatively via inherit:
  # inherit (self.users) blake;
  # let cool-users = [ blake ]; in ...
  #
  # To see this more interactively use the repl:
  # $ nix repl
  # nix-repl> :lf .
  # nix-repl> users.blake
  # { extraGroups = [ ... ]; initialHashedPassword = ""; isNormalUser = true; name = "blake"; openssh = { ... }; }
